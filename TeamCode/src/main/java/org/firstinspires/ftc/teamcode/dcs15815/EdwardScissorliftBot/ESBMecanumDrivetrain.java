...
public class ESBMecanumDrivetrain extends DefenderBotDrivetrain {

    public DcMotorEx backLeft, frontLeft, frontRight, backRight;


    public ESBMecanumDrivetrain(HardwareMap hm, DefenderBot b) {
	   super(hm, b);

	   backLeft = hm.get(DcMotorEx.class, ESBConfiguration.DRIVETRAIN_BACKLEFT_MOTOR_NAME);
	   frontLeft = hm.get(DcMotorEx.class, ESBConfiguration.DRIVETRAIN_FRONTLEFT_MOTOR_NAME);
	   frontRight = hm.get(DcMotorEx.class, ESBConfiguration.DRIVETRAIN_FRONTRIGHT_MOTOR_NAME);
	   backRight = hm.get(DcMotorEx.class, ESBConfiguration.DRIVETRAIN_BACKRIGHT_MOTOR_NAME);

	   backLeft.setDirection(ESBConfiguration.DRIVETRAIN_BACKLEFT_MOTOR_DIRECTION);
	   frontLeft.setDirection(ESBConfiguration.DRIVETRAIN_FRONTLEFT_MOTOR_DIRECTION);
	   frontRight.setDirection(ESBConfiguration.DRIVETRAIN_FRONTRIGHT_MOTOR_DIRECTION);
	   backRight.setDirection(ESBConfiguration.DRIVETRAIN_BACKRIGHT_MOTOR_DIRECTION);
    ...
    private void setProportionalPower(double bl, double fl, double fr, double br) {
	   double largest = ESBConfiguration.DRIVETRAIN_POWER_MAX;
...
//			 DcMotorSimple.Direction.REVERSE, DcMotorSimple.Direction.REVERSE);
	   ...
	   double maxTicksSecond = ESBConfiguration.DRIVETRAIN_MAX_TICKS_PER_SECOND;
