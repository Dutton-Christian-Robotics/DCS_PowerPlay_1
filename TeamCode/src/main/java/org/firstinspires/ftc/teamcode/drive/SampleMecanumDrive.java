...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(2.4, 0, 0);
...
//                new Pose2d(0.5, 0.5, Math.toRadians(5.0)), 0.5);
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.5, 0.5, Math.toRadians(5.0)), 0.15);
        ...
        // DONE: If the hub containing the IMU you are using is mounted so that the "REV" logo does
