...
@Autonomous(name = "Right / 4 cone attempt", group = "Right")
public class RIght_4_AutonomousOpMode extends LinearOpMode {
...
//	   Pose2d startingPose = bot.configPose2d("NAVIGATION_START_RED_LEFT");
	   ...
	   Trajectory t1_initialForward = bot.navigation.trajectoryBuilder(startingPose)
			 .forward(56)
			 .build();
	   Trajectory t2_approachHighJunction = bot.navigation.trajectoryBuilder(t1_initialForward.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_45)))
			 .forward(8)
			 .build();
	   Trajectory t3_backAwayFromHighJunction = bot.navigation.trajectoryBuilder(t2_approachHighJunction.end())
			 .back(8)
			 .build();
	   Trajectory t4_approachStack = bot.navigation.trajectoryBuilder(t3_backAwayFromHighJunction.end().plus(new Pose2d(0, 0, CLOCKWISE_135)))
			 .forward(29)
			 .build();
	   Trajectory t5_leaveStack = bot.navigation.trajectoryBuilder(t4_approachStack.end())
			 .back(12)
			 .build();
	   Trajectory t6_approachLowJunction = bot.navigation.trajectoryBuilder(t5_leaveStack.end().plus(new Pose2d(0, 0, CLOCKWISE_90)))
			 .forward(3)
			 .build();
	   Trajectory t7_leaveLowJunction = bot.navigation.trajectoryBuilder(t6_approachLowJunction.end())
			 .back(4)
			 .build();
	   Trajectory t8_approachStack = bot.navigation.trajectoryBuilder(t7_leaveLowJunction.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_90)))
			 .forward(14)
			 .build();
	   Trajectory t9_leaveStack = bot.navigation.trajectoryBuilder(t8_approachStack.end())
			 .back(12)
			 .build();
	   Trajectory t10_approachLowJunction = bot.navigation.trajectoryBuilder(t9_leaveStack.end().plus(new Pose2d(0, 0, CLOCKWISE_90)))
			 .forward(3)
			 .build();
	   ...
	   Trajectory t12_approachStack = bot.navigation.trajectoryBuilder(t11_leaveLowJunction.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_90)))
			 .forward(14)
			 .build();
	   ...
	   if (foundTagId < 1) {
		  ...
		  bot.lift.setPosition( LIFT_POSITION_HIGH); sleep(250);bot.navigation.turn(COUNTER_CLOCKWISE_45);


		  // drive toward junction
		  Trajectory t22_approachJunction = bot.navigation.trajectoryBuilder(t21_returnToHighJunction.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_45)))
				.forward(9)
				.build();
...
//		  bot.navigation.followTrajectory(t24_intoZone2);
		  ...
		  // drive toward junction
		  Trajectory t22_approachJunction = bot.navigation.trajectoryBuilder(t21_returnToHighJunction.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_135)))
				.forward(10)
				.build();
		  bot.navigation.followTrajectory(t22_approachJunction);
		  bot.lift.setPosition( LIFT_POSITION_BELOW_HIGH); sleep(250);
		  ...
		  Trajectory t24_intoZone2 = bot.navigation.trajectoryBuilder(t23_backAwayFromJunction.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_45)))
				.back(2)
				.build();
		  bot.navigation.followTrajectory(t24_intoZone2);
		  ...
		  Trajectory t22_approachLowJunction = bot.navigation.trajectoryBuilder(t21_leaveStack.end().plus(new Pose2d(0, 0, CLOCKWISE_90)))
				.forward(3)
				.build();
		  ...
		  Trajectory t24_intoZone3 = bot.navigation.trajectoryBuilder(t23_leaveLowJunction.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_90)))
				.forward(13)
				.build();

		  bot.navigation.followTrajectory(t24_intoZone3);
