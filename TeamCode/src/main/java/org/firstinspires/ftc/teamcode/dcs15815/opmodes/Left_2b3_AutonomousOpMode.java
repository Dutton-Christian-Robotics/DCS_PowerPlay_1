...
//	   Pose2d startingPose = bot.configPose2d("NAVIGATION_START_RED_LEFT");
	   ...
	   Trajectory t5_leaveStack = bot.navigation.trajectoryBuilder(t4_approachStack.end())
			 .back(6)
			 .build();
	   Trajectory t6_approachLowJunction = bot.navigation.trajectoryBuilder(t5_leaveStack.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_113)))
			 .forward(6)
			 .build();
	   Trajectory t7_leaveLowJunction = bot.navigation.trajectoryBuilder(t6_approachLowJunction.end())
			 .back(6)
			 .build();
	   Trajectory t8_approachStack = bot.navigation.trajectoryBuilder(t7_leaveLowJunction.end().plus(new Pose2d(0, 0, CLOCKWISE_113)))
			 .forward(7)
			 .build();
	   Trajectory t9_leaveStack = bot.navigation.trajectoryBuilder(t8_approachStack.end())
			 .back(6)
			 .build();
	   Trajectory t10_approachLowJunction = bot.navigation.trajectoryBuilder(t9_leaveStack.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_113)))
			 .forward(6)
			 .build();
	   Trajectory t11_leaveLowJunction = bot.navigation.trajectoryBuilder(t10_approachLowJunction.end())
			 .back(6)
			 .build();
	   Trajectory t12_approachStack = bot.navigation.trajectoryBuilder(t11_leaveLowJunction.end().plus(new Pose2d(0, 0, CLOCKWISE_113)))
			 .forward(7)
			 .build();
	   Trajectory t13_leaveStack = bot.navigation.trajectoryBuilder(t12_approachStack.end())
			 .back(6)
			 .build();
	   Trajectory t14_approachLowJunction = bot.navigation.trajectoryBuilder(t13_leaveStack.end().plus(new Pose2d(0, 0, COUNTER_CLOCKWISE_113)))
			 .forward(6)
			 .build();
	   ...
	   bot.navigation.turn(COUNTER_CLOCKWISE_113);
	   ...
	   bot.navigation.turn(CLOCKWISE_113);
